 ...
 */
function _uploadBareImage(tempFilePath, s3DesiredPath, options) {
    ...
    return imageUploader.upload(tempFilePath, s3DesiredPath).then(function (url) {
        return url;
 ...
 * @returns {Promise} URL of uploaded image
 */
function _uploadImageWithCallback(tempFilePath, s3DesiredPath, options, callback) {
...
module.exports = {
    ...
    liftImageWithCallback: _uploadImageWithCallback,
